...
namespace UFB.BLL
{
	...
	{
		private readonly UFB.DAL.DistributionService dal=new UFB.DAL.DistributionService();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public UFB.Model.Distribution GetModelByCache(int distributionID)
		{
			...
			return (UFB.Model.Distribution)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<UFB.Model.Distribution> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<UFB.Model.Distribution> DataTableToList(DataTable dt)
		{
			List<UFB.Model.Distribution> modelList = new List<UFB.Model.Distribution>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				UFB.Model.Distribution model;
