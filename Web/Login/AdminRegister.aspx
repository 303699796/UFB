<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRegister.aspx.cs" Inherits="UFB.Web.Login.AdminRegister" %>
                    ...
                    <div class="card-footer">
                       <div class="row">
                            ...
                            <div class="col-6">
                             ...
                             <div class="col-6">
                                 <asp:Button ID="Btn_Register" runat="server" Text="申请" CssClass ="btn btn-success btn-block" OnClick="Btn_Register_Click"/>
                               </div>
                            </div>
                        </div>
                    </div>
