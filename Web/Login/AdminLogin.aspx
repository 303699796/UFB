<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="UFB.Web.Login.AdminLogin" %>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-6">
                             ...
                             <div class="col-6">
                                 <asp:Button ID="Button_submit" runat="server" Text="登陆" CssClass="btn btn-primary px-5" OnClick="Button_submit_Click" />
